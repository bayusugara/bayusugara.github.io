...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title> Portfolio Website | Bayu Sugara </title>
 ...
 <section class="home" id="home">
   <div class="home-content">
     <div class="text">
       ...
       <div class="text-two">I'm Bayu Sugara</div>
       <div class="text-three">Programmer</div>
       <div class="text-four">From Pekanbaru</div>
     </div>
     <div class="button">
...
<footer>
  <div class="text">
    <span>Created By <a href="#">Bayu Sugara</a> | &#169; 2022 All Rights Reserved</span>
  </div>
</footer>
